                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                 {{ $statut->updated_at->format('d.m.yy')}}
                            </td>


                            <td class="text-center">
                                        <a class="btn bg-success text-white " href="{{ route('statuts.edit', $statut) }}" title="Modifier un statut"><i class="bi bi-pencil-square"></i></a>
