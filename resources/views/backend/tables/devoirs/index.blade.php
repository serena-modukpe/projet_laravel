...
<div class="row">
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Liste des devoirs</h5>
        <div class="card-text">
        <h5><a href="{{ route('devoirs.create') }}" title="Ajouter un devoir" style="text-decoration: none;">Ajouter un devoir<i class="bi bi-file-plus-fill"></i></a></h5>
        <div class="row table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @foreach ($devoirs as $interrogation)
                        <tr>
                            ...
                            <td class="text-center">
                                        <a class="btn bg-success text-white " href="{{ route('devoirs.edit', $interrogation) }}" title="Modifier un rôle"><i class="bi bi-pencil-square"></i></a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('devoirs.destroy', $interrogation->id) }}" style="display: inline;">
                                            <!-- CSRF token -->
                                            @csrf
                                            @method("DELETE")
