...
@section("content")
    ...
    <div class="card">
      <div class="card-body">
        <h3 class="card-title">Créer un statut inscription</h3>
        <div class="card-text">
            <div class="">
                ...
                <form method="POST" action="{{ route('inscriptions.store') }}" class="mt-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label for="site_id" class="col-4 fw-bold ">Site <i class="text-danger">*</i></label>
                        ...
                        <div class="col-12 pt-3">
                            ...
                            <a href="{{ route('inscriptions.index') }}" class="btn btn-secondary btn-sm">Annuler</a>
                        </div>
                    </div> 
                </form>
            </div>
